...
{
    public class Classroom3 : GameScreen
    {
        ...
        public static CSharpBook CSBook;
        ...
        public override void Activate()
        {
            ...
            _classroom = _content.Load<Texture2D>("Sprite_Classroom3");
            _overlay = _content.Load<Texture2D>("Sprite_C3Tables");
            circle = _content.Load<Texture2D>("circle");
            _bookCollect = _content.Load<SoundEffect>("Pickup_Special");

            if (!ScreenManager.CSharpBookCollected)
            {
                CSBook = new CSharpBook(new Vector2(720, 120));
                CSBook.LoadContent(_content);
            }


            _boundaries = new BoundingRectangle[]
                {
                    new BoundingRectangle(50, 30, 40, 270),
                    new BoundingRectangle(30, 340, 40, 1000),
                    new BoundingRectangle(0, 20, 680, 220),
                    new BoundingRectangle(830, 20, 500, 220),

                    new BoundingRectangle(500, 100, 1000, 80),
                    
                    new BoundingRectangle(1290, 100, 40, 1000),
                    new BoundingRectangle(1140, 200, 910, 90),
        ...
        public override void HandleInput(GameTime gameTime, InputState input)
        {
            ...
            else
            {
                ...
                {
                    ObjDoor7.Bounds = new BoundingRectangle(653, 0, 230, 250);
                }
                ...
                if (_student.FeetBounds.CollidesWith(CSBook.Bounds))
                {
                    ...
                    CSBook.Bounds = new BoundingRectangle(-100000, -100000, 1, 1);
                }
        ...
        {
            float playerX = MathHelper.Clamp(_student.Position.X, 300, 900);
            ...
            spriteBatch.Draw(_overlay, new Rectangle(0, 0, 1400, 500), Color.White);
